...
/*0000視差滾動0000000*/
  $('.parallax-window01').parallax({imageSrc:'images/bg-2.jpg'});
  $('.parallax-window02').parallax({imageSrc:'images/bg03.jpg'});
  $('.parallax-window03').parallax({imageSrc:'images/bg-2.jpg'});
